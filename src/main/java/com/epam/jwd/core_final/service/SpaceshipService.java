...
public interface SpaceshipService {
    ...
    void updateSpaceshipDetails(Spaceship spaceship) throws DuplicateEntityNameException;
    ...
    void createSpaceship(Spaceship spaceship) throws DuplicateEntityNameException;
}
